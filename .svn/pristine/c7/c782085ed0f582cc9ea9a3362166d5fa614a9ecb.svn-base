...
public class CodeGenerator {
    ...
    //数据库连接
    final static String MYSQL_URL = "jdbc:mysql://127.0.0.1:3306/fcg_serv?characterEncoding=utf8";
    /**
     * <p>
     * MySQL 生成演示
     * </p>
