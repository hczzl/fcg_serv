...
public class DateUtils {
    ...
    public static String getFormat(Date date, String format) {
        ...
        if (format.equals("MILL_SECOND")) {
            return String.valueOf(date.getTime());
        }
        Calendar ca = Calendar.getInstance();
        ca.setTime(date);
        String year = format(Integer.valueOf(ca.get(1)), "0000");
        String month = format(Integer.valueOf(ca.get(2) + 1), "00");
        String day = format(Integer.valueOf(ca.get(5)), "00");
        String hour = format(Integer.valueOf(ca.get(11)), "00");
        String minute = format(Integer.valueOf(ca.get(12)), "00");
        String second = format(Integer.valueOf(ca.get(13)), "00");
        String millSecond = format(Integer.valueOf(ca.get(14)), "00");
        return format.replaceAll("yyyy", year).replaceAll("MM", month)
                .replaceAll("dd", day).replaceAll("HH", hour)
                .replaceAll("mm", minute).replaceAll("ss", second).replace("ms", millSecond);
    }
